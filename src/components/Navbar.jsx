...
import ThemeToggeleBtn from './ThemeToggeleBtn'
...
const Navbar = ({ theme, setTheme }) => {
  ...
  flex sm:items-center gap-5 transition-all`}
            ...
            <div className='flex items-center gap-2 sm:gap-4'>
                ...
                <ThemeToggeleBtn theme={theme} setTheme={setTheme} />
                <img src={theme === 'dark' ? assets.menu_icon_dark : assets.menu_icon} onClick={() => sidebarOpen(true)} className='w-8 sm:hidden' alt="" />
