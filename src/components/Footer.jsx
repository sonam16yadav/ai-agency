...
viewport={{once:true}}
         className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-20 px-4 sm:px-10 lg:px-24 xl:px-40'>
...
viewport={{once:true}}
                ...
                <p className='max-w-md'>From strategy to execution, we craft digital solutions that move your business forward.
...
viewport={{once:true}}
            className='text-gray-600 dark:text-gray-400'>
                ...
                <div className='flex gap-2 text-sm'>
                    ...
                    dark:text-gray-200 bg-transparent border border-fray-300 dark:border-gyay-500' />
