    ...
    const workData=[
        {
        ...
        },
         {
            ...
            description:"We help you create a marketing strategy that drives results.Meet the team",
...
transition={{staggerChildren:0.2}}
    ...
    px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-grey-700 dark:text-white'>
